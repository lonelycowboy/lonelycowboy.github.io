...
// this function creates a three-column table and adds it to the screen
   var numDisplayed = 0;
   var tocTable = '';
   var tocHead1 = 'Entry Title';
   var tocTool1 = 'Click to sort by title';
   var tocHead2 = 'Entry Date';
   ...
   tocTable += '<a class="title" href="javascript:toggleTitleSort();" title="' + tocTool1 + '">' + tocHead1 + '</a>';
   tocTable += '</td>';
   tocTable += '<td class="toc-header-col2">';
   tocTable += '<a class="title" href="javascript:toggleDateSort();" title="' + tocTool2 + '">' + tocHead2 + '</a>';
   tocTable += '</td>';
   tocTable += '<td class="toc-header-col3">';
   tocTable += '<a class="title" href="javascript:allPosts();" title="' + tocTool3 + '">' + tocHead3 + '</a>';
   tocTable += '</td>';
   tocTable += '</tr>';
   ...
   if (numDisplayed == postTitle.length) {
      var tocNote = '<h4 class="toc-note">Displaying all ' + postTitle.length + ' posts<br/></h4>'; }
   else {
      var tocNote = '<h4 class="toc-note">Displaying ' + numDisplayed + ' posts labeled \'';
      tocNote += postFilter + '\' of '+ postTitle.length + ' posts total<br/></h4>';
   }
...
function showToc() {
  ...
  else { alert("Just wait... archive is loading"); }
}
